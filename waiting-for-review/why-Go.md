...
go不是系统语言,不是动态语言,不是web语言,是一个反抽象语言.

从机器人三定律看到编程三定律:

- 程序不要难到让他人不能理解,也不要缺少说明以至于产生误会
- 除非与第一条有冲突,程序应该快且简洁
- 除非与上面两条有冲突,程序的计算应该易于理解

还有人说:程序是给人读的,也仅仅是给机器执行的.

Go的设计就遵循了上面的规则:先给人读,之后让机器能跑的快且简洁.

不要过早优化,导出都可以看到这条.

上面的抱怨,在rust都得到了很好的解决,为什么还是选择go而不是rust?
rust是令人开心的,但是问题还是没解决,go是直面问题.
